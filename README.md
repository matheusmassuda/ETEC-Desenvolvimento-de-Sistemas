...
Os materiais e conteúdos são **divididos por semestres (módulos).** Clique nos **links** relativos aos **módulos (pastas)** e/ou **documentos** que deseja acessar. Quaisquer outros documentos e **informações auxiliares** importantes que **não** forem relativos às disciplinas estão centralizados na pasta Documentos Auxiliares.

### 📂 Módulo 1:
#### 🗃️ [Comunicação]
  - 📄 [Resumos]
  - 📑 [Exercícios]
#### 🗃️ [Desenvolvimento de Sistemas I]
   - 📄 [Resumos]
#### 🗃️ [Tecnologia da Informação I]
