<!--Link vídeo dicas PDO: https://www.youtube.com/watch?v=WwuFFyVKqEA -->
...
<body class="w3-blue">
    ...
    <div class="w3-paddingw-content w3-half w3-display-topmiddle w3-margin">

    <h1 class="w3-center w3-green w3-round-large w3-margin">Lista de Estados</h1>
