...
<body class="w3-black">
    ...
    <div class="w3-padding w3-content w3-text-grey w3-third w3-display-middle">
        ...
        <!--Declaração de variáveis comc redenciais do BD-->
        <?php
        $host = "localhost";
        $usuario = "pwii_user";
        $senha = "senha123";
        ...
        //Tenta criar um objeto PDO (conexão com MySQL)
        try{
